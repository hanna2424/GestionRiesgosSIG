...
<br><br><br>
<center>
    <h3><b>Registrar Zona Segura</b></h3><br><br><hr>
</center>
<div class="row">
    <div class="col-md-1"></div>
    <div class="col-md-10">
        <br>
        <form action="{{ route('seguro.store') }}" id="frm_val" method="post" autocomplete="off">
            @csrf
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input type="number" name="radio" id="radio" class="form-control" placeholder="Ingrese el radio de la zona" required><br>
                    <center>
