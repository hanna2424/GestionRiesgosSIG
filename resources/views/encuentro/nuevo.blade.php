...
<div class="row">
    ...
    <div class="col-md-10">
        <br>
        <form action="{{ route('encuentro.store') }}" id="frm_val" method="post" autocomplete="off">
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <label><b>Nombre del Punto de encuentro</b></label>
                    <input type="text" id="nombre" name="nombre" class="form-control" placeholder="Nombre del punto de encuentro" required><br>
                    <label><b>Capacidad</b></label>
                    <input type="number" id="capacidad" name="capacidad" class="form-control" placeholder="Ingrese la capacidad del punto" required><br>
                    <label><b>Responsable</b></label>
                    <input type="text" id="responsable" name="responsable" class="form-control" placeholder="Ingrese el responsable del punto" required><br>
